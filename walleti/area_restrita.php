...
//echo "Bem vindo <strong>". $_SESSION['nome'] ." ". $_SESSION['endereco'] ."</strong>!<br />
//echo ".$_SESSION[email].";
//Você está acessando área restrita para usuários cadastrados!
//<br /><br />";

//echo "Seu nível de usuário é <strong>". $_SESSION['nivel']."</strong>.
...
echo "<script language='javascript'>window.location='adm/principal.php';</script>";
}
...
//Acesso total <br /><br />";
echo "<script language='javascript'>window.location='professor/principal.php';</script>";
}
