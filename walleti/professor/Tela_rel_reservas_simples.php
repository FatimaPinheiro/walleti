        ...
        <div class="container section1">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Rel. de Reservas</li>
                </ol>
            </div>
            <div class="panel panel-primary">
                <div class="panel-heading">Rel. de Reservas</div>
                    ...
                    <form class="form-horizontal equipamento" method="post" action="">
                        <div class="row">
                            <div class="col-md-5">
                                <div>
                                    ...
                                    <select name="usuario" class="form-control" style="width: 90%;">
                                        <option></option>
                                    </select>
                                </div> 
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <select name="curso" class="form-control" style="width: 90%;">
                                    <option></option>
