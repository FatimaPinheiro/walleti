        ...
        <div class="container section1">
            ...
            <form class="form-horizontal equipamento" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nome" class="form-control" value="<?php echo $row['nome']; ?>" id="inputEmail3" placeholder="Nome" style="width: 70%;">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="quantidade" class="form-control" value="<?php echo $row['quantidade']; ?>" id="inputEmail3" placeholder="Quantidade de equipamentos" style="width: 70%;">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tombo" class="col-sm-2 control-label">Tombo</label>
                    <div class="col-sm-10">
                        <input type="int" name="tombo" class="form-control" value="<?php echo $row['tombo']; ?>" id="inputTombo" placeholder="Tombo do Equipamento" style="width: 70%;">
                    </div>
                </div>
                <div>
