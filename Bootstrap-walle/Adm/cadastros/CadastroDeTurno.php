...
<html lang="pt-br">
    ...
    <body>
        <div class="container section1">
            ...
            <form class="form-horizontal equipamento" method="post" action="../EnviarCadastroTurno.php">
                <div class="form-group">
                    <label for="turno" class="col-sm-2 control-label">Turno</label>
                    <div class="col-sm-10">
                        <input type="text" name="turno" class="form-control" id="inputTurno" placeholder="Ex. Matutino" style="width: 70%;">
                    </div>
                </div>
                <div>
