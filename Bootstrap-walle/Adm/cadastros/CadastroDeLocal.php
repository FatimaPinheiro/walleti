...
<html lang="pt-br">
    ...
    <body>
        <div class="container section1">
            ...
            <form class="form-horizontal equipamento" method="post" action="../EnviarCadastroLocal.php">
                <div class="form-group">
                    <label for="local" class="col-sm-2 control-label">Local</label>
                    <div class="col-sm-10">
                        <input type="text" name="nome" class="form-control" id="inputLocal" placeholder="Nome  do Local" style="width: 70%;">
                    </div>
                </div>
                <div>
