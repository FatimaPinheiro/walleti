...
<html lang="pt-br">
    ...
    <body>
        <div class="container section1">
            ...
            <div class="row">
                <div class="col-md-12">
            <button class="btn btn-lg btn-primary btn-block button" type="submit" style="background: #4F94CD; width: 20%; margin-right: 10px;"><a href="../cadastros/CadastroDeTurno.php">Novo</a></button>
                </div>
            </div>
            <div class = "container">
                <h3>Listagem de Horário</h3>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        while ($linha = mysql_fetch_assoc($resultado))
                        {
                            ...
                            echo '<td><a href="../Editar/EditarHorario.php?id='.$linha['id'].'"><img src="../img/alterar.png"></a></td>';
