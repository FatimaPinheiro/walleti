                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        while ($linha = mysql_fetch_assoc($resultado))
                        {
                            ...
                            echo '<td><a href="../Editar/EditarLocal.php?id='.$linha['id'].'"><img src="../img/alterar.png"></a></td>';
                            echo '<td><a href="../Editar/ExcluirLocal.php?id=' . $linha['id'] . '"><img src="../img/excluir.png"></img></a></td>';
                            echo '</tr>';
                        }
                        mysql_close($conexao);
                        ?>
